...
export const api = {
  ...
  syncPlanList:(connId)=>http.get("/sync-plans/plans",{params:{conn_id:connId}}),syncPlanGet:(planId)=>http.get("/sync-plans/plans/"+planId),syncPlanCreate:(data)=>http.post("/sync-plans/plans",data),syncPlanUpdate:(planId,data)=>http.put("/sync-plans/plans/"+planId,data),syncPlanDelete:(planId)=>http.delete("/sync-plans/plans/"+planId),syncPlanToggle:(planId,enable)=>http.post("/sync-plans/plans/"+planId+"/toggle",{enable}),syncPlanRunNow:(planId)=>http.post("/sync-plans/plans/"+planId+"/run-now"),monitorStatus:(connId)=>http.get("/monitor/"+connId+"/status"),sqlTaskList:(connId)=>http.get("/sql-tasks/tasks",{params:{conn_id:connId}}),sqlTaskGet:(taskId)=>http.get("/sql-tasks/tasks/"+taskId),sqlTaskCreate:(data)=>http.post("/sql-tasks/tasks",data),sqlTaskUpdate:(taskId,data)=>http.put("/sql-tasks/tasks/"+taskId,data),sqlTaskDelete:(taskId)=>http.delete("/sql-tasks/tasks/"+taskId),sqlTaskToggle:(taskId,enable)=>http.post("/sql-tasks/tasks/"+taskId+"/toggle",{enable}),sqlTaskRunNow:(taskId)=>http.post("/sql-tasks/tasks/"+taskId+"/run-now"),monitorVariables:(connId)=>http.get("/monitor/"+connId+"/variables"),backupPreview: (filename: string) =>
