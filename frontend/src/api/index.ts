...
export const api = {
  ...
  // SQL 执行
  executeSQL: (connId: number, sql: string, database?: string, schema?: string, signal?: AbortSignal, limit?: number, offset?: number) =>
    http.post('/query/execute', { conn_id: connId, sql, database, schema_name: schema, limit, offset }, { signal }) as Promise<ApiResponse<ExecResult>>,
