...
export interface TabItem {
  id: string
  title: string
  type: 'sql-workbench' | 'table-browser' | 'ai-chat' | 'ai-settings' | 'connection-list' | 'connection-detail' | 'view-manager' | 'function-manager' | 'trigger-manager' | 'event-manager' | 'settings'
