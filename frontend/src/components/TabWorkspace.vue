...
const componentMap: Record<string, any> = {
  ...
  'sync-plan-manager': markRaw(defineAsyncComponent(() => import('../views/SyncPlanManager.vue'))), 'backup-plan-manager': markRaw(defineAsyncComponent(() => import('../views/BackupPlanManager.vue'))),
