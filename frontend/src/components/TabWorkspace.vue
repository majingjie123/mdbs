...
const componentMap: Record<string, any> = {
  ...
  'performance-monitor:markRaw(defineAsyncComponent(()=>import("../views/PerformanceMonitor.vue"))),sync-plan-manager': markRaw(defineAsyncComponent(() => import('../views/SyncPlanManager.vue'))), 'backup-plan-manager': markRaw(defineAsyncComponent(() => import('../views/BackupPlanManager.vue'))),
