...
<template>
  <div class="backup-plan-manager">
    ...
    <n-spin :show="loading">
      ...
      <n-empty v-else description="暂无同步计划" />
    </n-spin>

    <!-- 新建/编辑对话框 -->
    <n-modal v-model:show="showDialog" :title="editingPlan ? '编辑同步计划' : '新建同步计划'" preset="card" style="width: 520px;" :mask-closable="false">
